...
def run_multi_project_build(master_config_path: str, skip_project_confirmation=True):
    ...
    for ahjo_project in ahjo_projects:
        ...
        are_you_sure_msg.append(
            " " * 2 + ", ".join(ahjo_projects[ahjo_project]["actions"])
        )
    are_you_sure_msg.append("")

    # Confirm action
    if not are_you_sure(are_you_sure_msg, False):
        return False
    ...
    for ahjo_project in ahjo_projects:
        ...
        try:
            ...
            logger = setup_ahjo_logger(
                ...
                enable_windows_event_log=project_config_dict.get(
                    "windows_event_log", False
                ),
                enable_sqlalchemy_log=project_config_dict.get(
        ...
        try:
            ...
            ahjo_action_files = project_config_dict.get(
            ...
            for action_file in ahjo_action_files:
                ...
                if not os.path.exists(
                    anchor_name + "/" + ahjo_project + "/" + action_source
                ):
                ...
                importlib.import_module(
                    anchor_name + "." + ahjo_project + "." + action_module
                )
